...
// ─── FIX: Tell dotenv exactly where .env is ───────────────────────────────────
// When running from root with "node server/server.js", dotenv looks in the
// wrong folder. This forces it to always find server/.env correctly.
